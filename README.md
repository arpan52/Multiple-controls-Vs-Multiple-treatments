...
# Description
This repository contains all the original **R** codes used for the numerical studies in the paper entitled **On power optimal designs for multiple treatment comparisons** authored by **_Arpan Singh_** and **_Satya Prakash Singh_**.
